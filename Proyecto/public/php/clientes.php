...
<body>
    ...
    <div class="flex flex-col items-center">
        <table class="table-auto m-5">
            ...
            ?>
                <tbody>
                    <tr>
                        <td class="border px-4 py-2"><?php echo $row->idclientes ?></td>
                        <td class="border px-4 py-2"><?php echo $row->nombre ?></td>
                        <td class="border px-4 py-2"><?php echo $row->cedula ?></td>
                        <td class="border px-4 py-2"><?php echo $row->direccion ?></td>
                    </tr>
                </tbody>
    ...
    <br>
    <div class="flex flex-col items-center">
        <button onclick="window.location.assign('addClient.php')" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
            Añadir Cliente
        </button>
    </div>
</body>
